...
;
;
.def BDOS	00005H	;BDOS ENTRY TO CP/M
.def WBOOT	00000H	;RE-ENTRY TO CP/M WARM BOOT
;
;
;
...
CALL	CPUER
J090:
ADI	070H	;A=76H,C=0,P=0,S=0,Z=0
	JPO	J100	;TEST "JPO"
	CALL	CPUER
J100:
JM	J110	;TEST "JM"
...
CALL	CPUER
J120:
ADI	081H	;A=F7H,C=0,P=0,S=1,Z=0
	JM	J130	;TEST "JM"
	CALL	CPUER
J130:
JZ	J140	;TEST "JZ"
...
CALL	CPUER
J150:
ADI	0FEH	;A=F5H,C=1,P=1,S=1,Z=0
	JC	J160	;TEST "JC"
	CALL	CPUER
J160:
JZ	J170	;TEST "JZ"
...
CALL	CPUER
ACII:
ACI	00AH	;A=F5H+0AH+CARRY(1)=0,C=1
...
SUI	00CH	;A=FFH,C=0
	...
	CALL	CPUER
SBII:
SBI	0F1H	;A=F0H-0F1H-CARRY(0)=FFH,C=1
	SBI	00EH	;A=FFH-OEH-CARRY(1)=F0H,C=0
	CPI	0F0H
	JZ	ANII	;TEST "SBI"
	CALL	CPUER
ANII:
ANI	055H	;A=F0H<AND>55H=50H,C=0,P=1,S=0,Z=0
	CPI	050H
	JZ	ORII	;TEST "ANI"
	CALL	CPUER
ORII:
ORI	03AH	;A=50H<OR>3AH=7AH,C=0,P=0,S=0,Z=0
	CPI	07AH
	JZ	XRII	;TEST "ORI"
	CALL	CPUER
XRII:
XRI	00FH	;A=7AH<XOR>0FH=75H,C=0,P=0,S=0,Z=0
	CPI	075H
	JZ	C010	;TEST "XRI"
	CALL	CPUER
;
...
ANI	000H	;A=0,C=0,P=1,S=0,Z=1
	...
	CALL	CPUER
C020:
SUI	077H	;A=89H,C=1,P=0,S=1,Z=0
	CNC	CPUER	;TEST "CNC"
	CPE	CPUER	;TEST "CPE"
	CP	CPUER	;TEST "CP"
	CZ	CPUER	;TEST "CZ"
...
;
CPUOK:
LXI	H,OKCPU	;OUTPUT "CPU IS OPERATIONAL" TO CONSOLE
	CALL	MSG
	JMP	WBOOT	;EXIT TO CP/M WARM BOOT
;
;
;
TEMPP:
DW	TEMP0	;POINTER USED TO TEST "LHLD","SHLD",
			; AND "LDAX" INSTRUCTIONS
;
TEMP0:
DS	1	;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP1:
DS	1	;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP2:
DS	1	;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
...
DS	1	;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
SAVSTK
	DS	2	;TEMPORARY STACK-POINTER STORAGE LOCATION
;
;
;
